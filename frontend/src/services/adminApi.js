...
export const addMovie = (movieId) => adminInstance.get(`/movie/add/${movieId}`);
export const editMovie = (values) => adminInstance.post(`/movie/edit/${values.id}`, { ...values });
...
export const addShow = (showId) => adminInstance.get(`/series/add-show/${showId}`);
