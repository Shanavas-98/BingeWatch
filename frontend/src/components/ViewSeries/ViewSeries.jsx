...
import { fetchSeriesDetails } from '../../services/userApi';
    ...
    return (
      <div className="grid grid-cols-2">
        ...
        <div className="md:col-span-1 col-span-2">
          ...
          <div className="flex mb-2">
            {createdBy?.map((person) => (
              <span className="text-white mx-1">{person.name}</span>
            ))}
          </div>
        ...
        <div className="col-span-2 ml-2">
          ...
          <CardCarousal cards={castCards} baseLink="/movies/view-movie/actor" style={cardStyle} />
          <h2 className="text-white text-lg mb-2">Crews</h2>
          <CardCarousal cards={crewCards} baseLink="/movies/view-movie/crew" style={cardStyle} />
        </div>
      </div>
    );
  }
