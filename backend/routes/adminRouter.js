...
const { getMovie, fetchMovies, fetchMovie, editMovie, fetchGenres, fetchActors, fetchCrews } = require('../controllers/movieController');
...
router.get('/movies/add-movie/:movieId',authAdmin,getMovie);
